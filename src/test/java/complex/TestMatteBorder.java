...
public class TestMatteBorder {
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(() -> {
			...
			helloThere.setBorder(new MyMatteBorder(spaceTop, spaceLeft, spaceBottom, spaceRight, fillTop, fillLeft,
					fillBottom, fillRight, Color.GREEN, Color.RED, Color.GRAY, Color.BLUE));
			JPanel p = new JPanel();
