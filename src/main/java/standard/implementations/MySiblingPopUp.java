...
public class MySiblingPopUp extends JWindow {
	...
	private MySiblingPopUp(final JComponent toShowAsPopUp, final CelestialDirection relativeDirectionOfPopUp,
			final int xOffset, final int yOffset, final MyFrame owner, final JComponent sibling) {
		super(owner);
	...
	public MySiblingPopUp(final JComponent toShowAsPopUp, final MyFrame owner, final JComponent sibling) {
		this(toShowAsPopUp, STANDARD_RELATIVE_DIRECTION_OF_POP_UP, STANDARD_X_LOCATION_OFFSET,
				STANDARD_Y_LOCATION_OFFSET, owner, sibling);
	}
