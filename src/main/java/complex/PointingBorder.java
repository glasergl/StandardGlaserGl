...
public class PointingBorder extends AbstractBorder {
	...
	public PointingBorder(final CelestialDirection edgeForPointer, final int height, final int width,
			final Color ofPointer, final Color ofLineBorder) {
		super();
	...
	@Override
	public void paintBorder(final Component toPutThisAround, final Graphics g, final int x, final int y, final int w,
			final int h) {
