...
public class MyMatteBorder extends AbstractBorder {
    ...
    public MyMatteBorder(final int topSpace, final int leftSpace, final int botSpace, final int rightSpace, final int top, final int left, final int bot, final int right, final Color topColor,
	    final Color leftColor, final Color botColor, final Color rightColor) {
	super();
	if (topSpace < 0 || leftSpace < 0 || botSpace < 0 || rightSpace < 0 || top < 0 || left < 0 || bot < 0 || right < 0) {
    ...
    public MyMatteBorder(final int spaceTop, final int spaceLeft, final int spaceBottom, final int spaceRight, final int fillTop, final int fillLeft, final int fillBottom, final int fillRight,
	    final Color color) {
	this(spaceTop, spaceLeft, spaceBottom, spaceRight, fillTop, fillLeft, fillBottom, fillRight, color, color, color, color);
    }
